 ...
 * @see app/Http/Controllers/Api/ShuttleLocationController.php:15
 ...
 * @see app/Http/Controllers/Api/ShuttleLocationController.php:20
 * @route '/api/shuttle-locations'
 */
 ...
 * @see app/Http/Controllers/Api/ShuttleLocationController.php:140
 ...
 * @see app/Http/Controllers/Api/ShuttleLocationController.php:145
 * @route '/api/shuttle-locations/{shuttle_location}'
 */
 ...
 * @see app/Http/Controllers/Api/ShuttleLocationController.php:158
 * @route '/api/shuttle-locations/{shuttle_location}'
 */
...
/**
* @see \App\Http\Controllers\Api\ShuttleLocationController::storeFromDriver
 * @see app/Http/Controllers/Api/ShuttleLocationController.php:46
 * @route '/api/driver/location'
 */
export const storeFromDriver = (options?: RouteQueryOptions): RouteDefinition<'post'> => ({
    url: storeFromDriver.url(options),
    method: 'post',
})

storeFromDriver.definition = {
    methods: ["post"],
 ...
 * @route '/api/driver/location'
 */
storeFromDriver.url = (options?: RouteQueryOptions) => {
    return storeFromDriver.definition.url + queryParams(options)
}
 ...
 * @route '/api/driver/location'
 */
storeFromDriver.post = (options?: RouteQueryOptions): RouteDefinition<'post'> => ({
    url: storeFromDriver.url(options),
    method: 'post',
})
 ...
 * @route '/api/driver/location'
 */
    const storeFromDriverForm = (options?: RouteQueryOptions): RouteFormDefinition<'post'> => ({
        action: storeFromDriver.url(options),
        method: 'post',
    })
 ...
 * @route '/api/driver/location'
 */
        storeFromDriverForm.post = (options?: RouteQueryOptions): RouteFormDefinition<'post'> => ({
            action: storeFromDriver.url(options),
            method: 'post',
        })
    
    storeFromDriver.form = storeFromDriverForm
const ShuttleLocationController = { index, store, show, update, destroy, storeFromDriver }

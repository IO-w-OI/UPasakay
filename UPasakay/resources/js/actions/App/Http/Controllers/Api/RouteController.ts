...
export const shuttles = (args: { route: number | { id: number } } | [route: number | { id: number } ] | number | { id: number }, options?: RouteQueryOptions): RouteDefinition<'get'> => ({
    url: shuttles.url(args, options),
    method: 'get',
})

shuttles.definition = {
    methods: ["get","head"],
    url: '/api/routes/{route}/shuttles',
...
shuttles.url = (args: { route: number | { id: number } } | [route: number | { id: number } ] | number | { id: number }, options?: RouteQueryOptions) => {
    ...
    return shuttles.definition.url
 ...
 */
    const shuttlesForm = (args: { route: number | { id: number } } | [route: number | { id: number } ] | number | { id: number }, options?: RouteQueryOptions): RouteFormDefinition<'get'> => ({
        action: shuttles.url(args, options),
        method: 'get',
    })
 ...
 */
    ...
    shuttles.form = shuttlesForm
/**
* @see \App\Http\Controllers\Api\RouteController::index
 * @see app/Http/Controllers/Api/RouteController.php:13
 * @route '/api/routes'
 */
...
const RouteController = { shuttles, index, store, show, update, destroy }

 ...
 * @see app/Http/Controllers/Api/NotificationController.php:181
 ...
 * @see app/Http/Controllers/Api/NotificationController.php:127
 ...
 * @see app/Http/Controllers/Api/NotificationController.php:141
 * @route '/api/notifications/process-scheduled'
 */
export const processScheduled = (options?: RouteQueryOptions): RouteDefinition<'post'> => ({
    url: processScheduled.url(options),
    method: 'post',
})

processScheduled.definition = {
    methods: ["post"],
...
processScheduled.url = (options?: RouteQueryOptions) => {
    return processScheduled.definition.url + queryParams(options)
}
 ...
 */
    const processScheduledForm = (options?: RouteQueryOptions): RouteFormDefinition<'post'> => ({
        action: processScheduled.url(options),
        method: 'post',
    })
 ...
 * @see app/Http/Controllers/Api/NotificationController.php:84
 * @route '/api/notifications/{notification}'
 */
 ...
 * @see app/Http/Controllers/Api/NotificationController.php:105
...
processScheduled: Object.assign(processScheduled, processScheduled),
